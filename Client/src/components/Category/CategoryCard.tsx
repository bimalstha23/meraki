...
export const CategoryCard = (props:categoryprops) => {
    ...
    <div className='flex flex-col h-60 rounded-3xl bg-[#FEEAE0]'>
        ...
        <button className='bg-white  w-24 ml-5 mt-6 p-2 text-xs rounded-3xl drop-shadow-lg hover:bg-gradient-to-r from-[#FFBA98] to-[#FCCAB1] transition-all '>Browse Items</button>
    </div>
  )
}
